...
export default function Terms() {
  ...
  return (
    <>
      <CustomHead
        pageTitle="Cubópolis - Termos de Uso"
        pageDescription="Leia os termos de uso da loja do Cubópolis e saiba mais sobre suas responsabilidades ao utilizar nossos serviços."
        pageUrl="https://cubopolis.com.br/terms"
      />
      ...
      <MainLayout>
        ...
        <main className={styles.main}>
          ...
          <div className={styles.container}>
            ...
            <p>
              O uso contínuo ou realização de qualquer compra em nosso site será considerado como aceitação dos nossos termos de uso. Se você tiver alguma dúvida sobre estes termos, entre em contato conosco no <Link href={'/discord'}>Discord do Cubópolis</Link> antes de usar a loja.
            </p>
          </div>
