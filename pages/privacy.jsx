...
export default function Privacy() {
  ...
  return (
    <>
      <CustomHead
        pageTitle="Cubópolis - Política de Privacidade"
        pageDescription="Saiba como o Cubópolis coleta, usa e protege suas informações pessoais em nossa loja online."
        pageUrl="https://cubopolis.com.br/privacy"
      />
      ...
      <MainLayout>
        ...
        <main className={styles.main}>
          ...
          <div className={styles.container}>
            ...
            <p>
              O uso contínuo ou realização de qualquer compra em nosso site será considerado como aceitação das nossas práticas de privacidade. Se tiver dúvidas sobre como tratamos dados pessoais, entre em contato conosco no <Link href={'/discord'}>Discord do Cubópolis</Link> antes de usar a loja.
            </p>
          </div>
