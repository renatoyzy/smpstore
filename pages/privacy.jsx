...
export default function Privacy() {
  ...
  return (
    <>
      <CustomHead
        pageTitle="Legião Templária - Política de Privacidade"
        pageDescription="Saiba como o Legião Templária coleta, usa e protege suas informações pessoais em nossa loja online."
        pageUrl="https://legiaotemplaria.com/privacy"
      />
      ...
      <MainLayout>
        ...
        <main className={styles.main}>
          ...
          <div className={styles.container}>
            ...
            <p>
              O uso contínuo ou realização de qualquer compra em nosso site será considerado como aceitação das nossas práticas de privacidade. Se tiver dúvidas sobre como tratamos dados pessoais, entre em contato conosco no <Link href={'/discord'}>Discord do Legião Templária</Link> antes de usar a loja.
            </p>
          </div>
